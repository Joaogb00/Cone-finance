<template>
    <header :class="{ active: isHovered }" @mouseenter="isHovered = true" @mouseleave="isHovered = false">
        ...
        <router-link to="/usuariocadastrado">
        ...
        <div class="links">
            ...
            <div class="link-container">
                ...
                <div class="dropdown-menu" v-if="isDropdownOpen">
                    <router-link to="/dashboard" class="dropdown-item"> Meus Investimentos</router-link>
                    <router-link to="/dashboard" class="dropdown-item"> Planejamento Financeiro</router-link>
                    <router-link to="/dashboard" class="dropdown-item"> Simulações</router-link>
            ...
            <router-link to="/dashboard" class="link" @click.prevent="closeAllDropdowns">
                Minha dashboard
            </router-link>
